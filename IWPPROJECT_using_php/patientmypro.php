...
button
  ...
  <div class="main">
    <form action="patientmyproedit.php" method="post">
    <div class="padd">
      ...
      if($result -> num_rows > 0)
      {
        while ($row = $result -> fetch_assoc()) 
        {
          if($row["pno"]==$id)
          {
            ...
            echo "<tr><td class='col'>First Name: </td><td>".$row["pfname"]."</td></tr>";
            echo "<tr><td class='col'>Last Name: </td><td>".$row["plname"]."</td></tr>";
            echo "<tr><td class='col'>Registration Number: </td><td>".$row["pno"]."</td></tr><tr><td class='col'>Date of Birth: </td><td>".$df."</td></tr>";
            echo "<tr><td class='col'>Age: </td><td>".$diff->format('%y')."</td></tr><tr><td class='col'>Gender: </td><td>".$row["pgen"]."</td></tr>";
            echo "<tr><td class='col'>Country: </td><td>".$row['pcountry']."</td></tr>";
