...
<head>
  ...
  <body>
	...
	<h1 style="padding-bottom: 10px;">MANAGE DOCTORS</h1>   	
	...
	<div class="padd">
		<table id="test_table" style="width: 95%; margin-top: 2%;">
			...
			if(isset($_GET['category']))
			{
				...
				$sql="DELETE from doctor where dno='$category'";
			...
			if($respatient -> num_rows > 0)
			{
				while ($row = $respatient->fetch_assoc()) 
				{
            		...
            		$age=$diff->format('%y');
					echo "<tr><td>".$i."</td><td>".$no."</td><td>".$name."</td><td>".$gen."</td><td>".$age."</td><td>".$spec."</td><td>".$mobile."</td><td>".$mail."</td><td>"; ?>
						<a href='managedoctor.php?category=<?php echo $no; ?> '><button type='button' class='btn btn-danger'>
