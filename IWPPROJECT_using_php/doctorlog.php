...
<body bgcolor="#d6c2c2"> 
  ...
  <ol class="breadcrumb justify-content-end">
    ...
    <li class="breadcrumb-item active" aria-current="page">Doctor log</li>
  </ol>
	</nav>
<h2 style="padding-top: 3%;"><center>Doctor session log</center></h2>
	...
	<table id="test_table" style="width: 95%;">
			...
			<?php
			include("connection.php");
			$query=mysqli_query($connect,"select * from doctorlog");
			$cnt=1;
...
<a href="deldlog.php"><center><button type="submit">Delete all logs</button></center></a>
</body>
</html>
<?php
} 
